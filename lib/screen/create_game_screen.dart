...
class _CreateGameScreenState extends State<CreateGameScreen> {
  ...
  final List<GameType> gameTypeList = GameType.values.sublist(1, 4);
  late GameType selectedGameType;
  final List<String> gameProvinceList = UtilData.provienceList;
                      ...
                      children: [
                        ...
                        PlatformWidget(
                            ...
                            cupertino: (_, __) => GestureDetector(
                                  ...
                                  onTap: () =>
                                      cupertinoGameTypeSelector(context),
                                ))
                      ],
                    ),
                  ),
                  ...
                  PlatformElevatedButton(
                    ...
                    onPressed: () async {
                      DialogUtils.createLoadingDialog(
                          context, "Yükleniyor", "Oyun oluşturuluyor");
                      if (titleController.text.isNotEmpty &&
                          descController.text.isNotEmpty) {
                        bool result = await gameGet.createGame(
                        ...
                        Navigator.of(Get.overlayContext!, rootNavigator: true)
                            .pop();
                        Get.snackbar(
                            "Hata", "Gerekli bilgileri doldurunuz lütfen");
                      }
                    },
                  )
                ],
